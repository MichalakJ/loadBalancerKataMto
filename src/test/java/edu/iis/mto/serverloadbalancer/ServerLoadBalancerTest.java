...
public class ServerLoadBalancerTest {
    ...
    public void balancingServerWithEnoughRoom_getsFilledWithAllVm(){
        ...
        assertThat(server, VmCountMatcher.hasVmCountOf(2));
    ...
    @Test
    public void vmShouldBeBalanced_onLessLoadedServer(){
        Server lessLoadedserver = a(server().withCapacity(10).withLoadPercentage(50));
        Server moreLoadedserver = a(server().withCapacity(10).withLoadPercentage(80));
        Vm vm = a(vm().withSize(1));
    ...
    public void balanceServer_andVms(){
        ...
        assertThat("server1 contains vm3", server1.contains(vm3));

        assertThat(server1, hasCurrentPercentageLoadOf(70.0d));
        assertThat(server2, hasCurrentPercentageLoadOf(80.0d));
    }
